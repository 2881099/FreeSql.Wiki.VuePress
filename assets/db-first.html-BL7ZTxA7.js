import{_ as e}from"./plugin-vue_export-helper-DlAUqK2U.js";import{o as a,c as s,e as n}from"./app-DL2CsOPp.js";const t={},i=n(`<h1 id="dbfirst" tabindex="-1"><a class="header-anchor" href="#dbfirst" aria-hidden="true">#</a> DbFirst</h1><div class="language-csharp line-numbers-mode" data-ext="cs"><pre class="language-csharp"><code><span class="token class-name">IFreeSql</span> fsql<span class="token punctuation">;</span> <span class="token comment">// For creation details, please refer to the Getting Started documentation</span>
