import{_ as a}from"./plugin-vue_export-helper-DlAUqK2U.js";import{o as s,c as n,a as t}from"./app-CPBDGH-p.js";const i={};function r(o,e){return s(),n("div",null,e[0]||(e[0]=[t(`<h1 id="dbfirst" tabindex="-1"><a class="header-anchor" href="#dbfirst" aria-hidden="true">#</a> DbFirst</h1><div class="language-csharp line-numbers-mode" data-ext="cs"><pre class="language-csharp"><code><span class="token class-name">IFreeSql</span> fsql<span class="token punctuation">;</span> <span class="token comment">// For creation details, please refer to the Getting Started documentation</span>
