import{_ as l}from"./plugin-vue_export-helper-DlAUqK2U.js";import{r as o,o as r,c as d,a as i,b as n,d as a,e as t}from"./app-CbJXcJcp.js";const u={},c={href:"https://www.cnblogs.com/igeekfan/p/freesql-generator.html",target:"_blank",rel:"noopener noreferrer"},p={href:"https://github.com/2881099/FreeSql.Tools",target:"_blank",rel:"noopener noreferrer"},m={href:"https://github.com/mypeng1985",target:"_blank",rel:"noopener noreferrer"};function v(b,e){const s=o("ExternalLinkIcon");return r(),d("div",null,[e[6]||(e[6]=i(`<h1 id="dbfirst" tabindex="-1"><a class="header-anchor" href="#dbfirst" aria-hidden="true">#</a> DbFirst</h1><div class="language-csharp line-numbers-mode" data-ext="cs"><pre class="language-csharp"><code><span class="token keyword">static</span> <span class="token class-name">IFreeSql</span> fsql <span class="token operator">=</span> <span class="token keyword">new</span> <span class="token constructor-invocation class-name">FreeSql<span class="token punctuation">.</span>FreeSqlBuilder</span><span class="token punctuation">(</span><span class="token punctuation">)</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>命令行工具生成实体类极大好处，后续再次生成覆盖操作等于一键完成，并且支持 Mac/Linux 平台。</p>`,15)),n("p",null,[n("a",c,[e[0]||(e[0]=a("详细解读：生成器是如何实现的？")),t(s)])]),e[7]||(e[7]=i(`<div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>C:\\WINDOWS\\system32&gt;FreeSql.Generator --help
        ____                   ____         __
...
-DB &quot;KingbaseES,server=127.0.0.1;port=54321;uid=USER2;pwd=123456789;database=数据库&quot;
-DB &quot;ShenTong,host=192.168.164.10;port=2003;database=数据库;username=SYSDBA;password=szoscar55;maxpoolsize=2&quot;
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="示例" tabindex="-1"><a class="header-anchor" href="#示例" aria-hidden="true">#</a> 示例</h3><blockquote><p>FreeSql.Generator -Razor 1 -NameOptions 0,0,0,1 -NameSpace LinCms.Core.Entities -DB &quot;MySql,Data Source=127.0.0.1;Port=3306;User ID=root;Password=123456;Initial Catalog=lincms;Charset=utf8;SslMode=none;Max pool size=2&quot;</p></blockquote><ul><li>数据库表名是下划线，字段也是下划线方式。</li><li>-Razor 指定 第一个模板</li><li>-NameOptions 0,0,0,1 最后一个 1，代表 下划线转驼峰，满足 C#命名规则</li><li>-NameSpace 指定了命名空间 LinCms.Core.Entities</li><li>-DB 就是数据库的相关配置</li><li>mysql 本地地址 127.0.0.1 3306 端口 用户名 root 密码 123456 数据库 lin-cms</li><li>-Match book 这样就能只生成 book，支持正则表达式，如 -Match lin<em>user 就会生成以 lin_user 开头的表。如 dbo.TB</em>.+，会生成以 TB 开头的表。即只生成匹配的表</li></ul><h2 id="安装-winform-生成器-已停止更新" tabindex="-1"><a class="header-anchor" href="#安装-winform-生成器-已停止更新" aria-hidden="true">#</a> 安装 Winform 生成器（已停止更新）</h2>`,9)),n("p",null,[e[2]||(e[2]=a("源码地址：")),n("a",p,[e[1]||(e[1]=a("FreeSql.Tools")),t(s)])]),n("blockquote",null,[n("p",null,[e[4]||(e[4]=a("作者：")),n("a",m,[e[3]||(e[3]=a("mypeng1985")),t(s)]),e[5]||(e[5]=a(" 开发了两个版本"))])]),e[8]||(e[8]=n("figure",null,[n("img",{src:"https://user-images.githubusercontent.com/16286519/76141354-4790e980-609e-11ea-869b-bb2c6980d98f.png",alt:"image",tabindex:"0",loading:"lazy"}),n("figcaption",null,"image")],-1)),e[9]||(e[9]=n("figure",null,[n("img",{src:"https://user-images.githubusercontent.com/16286519/58793525-e0cf3300-8628-11e9-8959-d2efed685843.png",alt:"image",tabindex:"0",loading:"lazy"}),n("figcaption",null,"image")],-1))])}const q=l(u,[["render",v],["__file","db-first.html.vue"]]);export{q as default};
