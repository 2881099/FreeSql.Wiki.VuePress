...
| [FreeSql.Provider.MySqlConnector](freesql-provider-mysqlconnector.md) | 基于 MySqlConnector（开源社区，推荐++）<br>_MySQL, MariaDB, Percona, Amazon Aurora, Azure Database for MySQL, Google Cloud SQL for MySQL, OceanBase, Doris, Tidb 等等_ |
